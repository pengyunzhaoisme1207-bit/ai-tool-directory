...
<ScreenshotFigure
  ...
  caption="Official Claude Code site snapshot. Terminal-native products should be judged by their workflow fit, documentation clarity, and handoff model, not just by one demo clip."
...
<ScreenshotFigure
  ...
  alt="Cursor homepage screenshot"
  caption="Official Cursor homepage snapshot. For agentic editors, the real buying question is how the workspace, models, and review loop fit into everyday development."
  source="cursor.com"
/>
