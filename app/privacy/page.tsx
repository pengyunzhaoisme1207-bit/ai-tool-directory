    ...
    <article className="mx-auto max-w-5xl">
      <header className="mb-8 rounded-2xl border border-gray-200 bg-[linear-gradient(135deg,#f8fafc_0%,#ffffff_50%,#eef6ff_100%)] p-6 shadow-sm dark:border-gray-800 dark:bg-[linear-gradient(135deg,#020617_0%,#111827_55%,#0f172a_100%)]">
        <p className="text-xs font-semibold tracking-wide text-blue-700 uppercase dark:text-blue-400">
          Privacy and advertising disclosure
        </p>
        <h1 className="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">Privacy Policy</h1>
        <p className="mt-3 max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-400">
          How Next Happy AI Tools handles cookies, analytics, Google AdSense advertising,
          third-party links, and privacy choices for visitors.
        </p>
      ...
      <div className="prose prose-gray dark:prose-invert mx-auto max-w-3xl">
        ...
        <p>
          Next Happy AI Tools ("we", "our", or "us") is committed to protecting your privacy. This
        ...
        <ul>
          ...
          <li>
            <strong>Web Beacons</strong> — transparent pixel images used to track user navigation
        ...
        <p>
          Our Site may contain links to third-party websites, including AI tool websites we review.
          We are not responsible for the privacy practices of those sites. We encourage you to read
          the privacy policies of any third-party site before providing personal information.
        </p>
        ...
        <p>
          You can also learn how Google uses information from sites and apps that use Google
          services at{' '}
          <a
