    ...
    <article className="mx-auto max-w-5xl">
      <header className="mb-8 rounded-2xl border border-gray-200 bg-[linear-gradient(135deg,#f8fafc_0%,#ffffff_50%,#eef6ff_100%)] p-6 shadow-sm dark:border-gray-800 dark:bg-[linear-gradient(135deg,#020617_0%,#111827_55%,#0f172a_100%)]">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-gray-600 dark:text-gray-400">
          Terms for using Next Happy AI Tools, including content accuracy, third-party links,
          advertising disclosures, and affiliate transparency.
        </p>
        <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">Last updated: May 11, 2026</p>
      </header>

      <div className="prose prose-gray dark:prose-invert mx-auto max-w-3xl">
        <h2>1. Acceptance of Terms</h2>
        <p>
          By accessing and using Next Happy AI Tools (<strong>www.next-happy.com</strong>), you
        ...
        <p>
          Next Happy AI Tools provides curated reviews, comparisons, and analysis of artificial
          intelligence tools and services. Our content includes written reviews, feature
          comparisons, pricing information, and recommendations to help users find the right AI
        ...
        <p>
          Some links on this Site may be affiliate links. If you click on an affiliate link and make
          a purchase, we may receive a commission at no additional cost to you. This helps support
          our independent reviews and content creation. We only recommend tools we genuinely believe
        ...
        <p>
          ...
          software, is the property of Next Happy AI Tools or its content suppliers and is protected
          by intellectual property laws. Unauthorized reproduction or distribution is prohibited.
        </p>
        ...
        <p>
          To the maximum extent permitted by law, Next Happy AI Tools shall not be liable for any
          direct, indirect, incidental, consequential, or punitive damages arising out of or
          relating to your use of the Site or reliance on any information provided herein.
        </p>
